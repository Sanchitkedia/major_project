...
def processFeedback(feedback):
    ...
    if feedback.event_type == InteractiveMarkerFeedback.MENU_SELECT:
        if feedback.menu_entry_id==1:
            ...
            listener.waitForTransform('/link06','/world',rospy.Time(), rospy.Duration(1.0))
            (trans,rot)=listener.lookupTransform('link01','link06',rospy.Time())
            print trans,rot
...
if __name__=="__main__":
	...
	print listener.frameExists('link06')
	(trans,rot)=listener.lookupTransform('world','link06',rospy.Time())
	print trans,rot
